...
const contractABI = require("../artifacts/contracts/Broadcastloom.sol/Broadcastloom.json").abi;

program
    .name("broadcastloom-cli")
    .description("CLI tool for Broadcastloom smart contract")
    .version("1.0.0");
